...
{
    [CreateAssetMenu(fileName = "New VirtualCam Settings", menuName = "Cinemachine/VirtualCamera Settings"), InlineEditor]
    public class TpsCameraProperties : ScriptableObject
    {
        ...
        public void SetCameraProperties(CinemachineVirtualCamera vCam)
        {
            if (!vCam)
                return;
