...
namespace _ScriptableObjects.Traps
{
    ...
    public class BallistaProperties : TrapSO
    {
        ...
        [BoxGroup("Properties"), LabelWidth(100), Range(0f, 0.5f), GUIColor(1, 2, 3)]
        public float smoothRotation = 0.125f;
        [BoxGroup("Properties"), LabelWidth(100), Range(0f, 10f), GUIColor(1, 2, 3)]
        public float fireRate = 2f;

        [TitleGroup("Properties/Projectile"), LabelWidth(100)]
        public Projectile projectilePrefab;
        [TitleGroup("Properties/Projectile"), LabelWidth(100), Range(0f, 30f), GUIColor(1, 2, 3)]
