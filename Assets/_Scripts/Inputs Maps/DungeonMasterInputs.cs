...
//     version 1.4.3
//     from Assets/_Scripts/Inputs Maps/DungeonMasterInputs.inputactions
//
...
{
    public partial class @DungeonMasterInputs : IInputActionCollection2, IDisposable
    {
        public InputActionAsset asset { get; }
        public @DungeonMasterInputs()
        {
            asset = InputActionAsset.FromJson(@"{
    ""name"": ""DungeonMasterInputs"",
    ""maps"": [
        {
            ""name"": ""Controls"",
    ...
    ""controlSchemes"": [
        ...
        {
            private @DungeonMasterInputs m_Wrapper;
            public ControlsActions(@DungeonMasterInputs wrapper) { m_Wrapper = wrapper; }
